        ...
        <div class="tnc_sub_section">
            <div class="tnc__head">
                ...
                <p class="tnc_para">
                    ...
                    this website and accepting the Company’s terms and conditions. “The Company”, “Ourselves”, “We” and
                    ...
                    accordance with and subject to, prevailing Law. Any use of the above terminology or other words in
                ...
                <p class="tnc_para">
                    ...
                    systems and data to ensure the best possible service to our customers. Parliament has created
                    specific offences for unauthorised actions against computer systems and data. We will investigate
                    any such actions with a view to prosecuting and/or taking civil proceedings to recover damages
                    against those responsible. </p>
                <h4 class="tnc_head_title" >
                    CONFIDENTIALITY </h4>
                <p class="tnc_para">
                    ...
                    provision that we are given reasonable notice of such a request, the company has the right to turn
                    down requests at their discretion. Clients are requested to retain copies of any literature issued
                    in relation to the provision of our services. Where appropriate, we shall issue Client’s with
                    appropriate written information, handouts or copies of records as part of an agreed contract, for
                ...
                <p class="tnc_para">
                    ...
                    inaccuracies or omissions in this website and/or the Company’s literature; and </p>
                <h4 class="tnc_head_title" >
                </h4>
                <p class="tnc_head_title">
                ...
                <h4 class="tnc_head_title" >
                    AVAILABILITY </h4>
                <p class="tnc_para">
                    All advertising is intended solely for the online market. You are solely responsible for evaluating
                    the fitness for a particular purpose of any downloads, programs and text available through this
                    site. Redistribution or republication of any part of this site or its content is prohibited,
                    including such by framing or other similar or any other means, without the express written consent
                    of the Company. The Company does not warrant that the service from this site will be uninterrupted,
                    timely or error free, although it is provided to the best ability. By using this service you thereby
                    indemnify this Company, its employees, agents and affiliates against any loss or damage in whatever
                    manner, howsoever caused. </p>
                <h4 class="tnc_head_title" >
                    LOG FILES </h4>
                <p class="tnc_para">
                    ...
                    access times/open mail, URL requested, and referral URL. This information is not shared with third
                ...
                <p class="tnc_para">
                    ...
                    functionality of this area and ease of use for those people visiting. Some of our affiliate partners
                    may also use cookies. </p>
                <h4 class="tnc_head_title" >
                    LINKS TO THIS WEBSITE </h4>
                <p class="tnc_para">
                    ...
                    limitations set out above will apply to your use of this website by linking to it. </p>
                <h4 class="tnc_head_title" >
                    COPYRIGHT NOTICE </h4>
                <p class="tnc_para">
                    Copyright and other relevant intellectual property rights exist on all text relating to the
                    Company’s services and the full content of this website. </p>
                <h4 class="tnc_head_title" >
                    NOTIFICATION OF CHANGES </h4>
                <p class="tnc_para">
                    The Company reserves the right to change these conditions from time to time as it deems fit and your
