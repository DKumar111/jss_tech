...
<body>
    ...
    <div class="currentOpening_section">
        <div class="currentOpening_container">
            ...
            <div class="currentOpenings_cards_section    ">
                ...
                <div class="currentOpenings_card" data-aos="fade-up" data-aos-once="true">
                    <h4 class="currenOpenings_card_title">React Js Developer</h4>
                    <p>We are looking for experienced React Js Developers who can work with us on new ambitious projects
                        and enhance their skills.</p>
                    <a class="currentOpenings_anchor_item" href="#">Apply Now</a>
                </div>
                <div class="currentOpenings_card " data-aos="fade-up" data-aos-once="true">
                    <h4 class="currenOpenings_card_title">Sales Executive</h4>
                    <p>We are looking for an energetic Sales Executive to be added in our Sales and Business development
                        team.</p>
                    <a class="currentOpenings_anchor_item" href="#">Apply Now</a>
                </div>
                ...
                <div class="currentOpenings_card" data-aos="fade-up" data-aos-once="true">
                    <h4 class="currenOpenings_card_title">UX Designer</h4>
                    <p>We are looking for a dynamic UX Designer to be added in our Design team.</p>
                    <a class="currentOpenings_anchor_item" href="#">Apply Now</a>
                </div>
            </div>
        </div>
