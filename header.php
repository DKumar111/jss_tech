    ...
    <div class="header_container">
        <div class="brand_logo">
            <a class="brand_logo_anchor" href="index.php">
                <img src="image/JSS-LOGO.png" alt="">
            </a>
        </div>
        <div class="navigation">
            <nav class="navigation_content">
                <ul class="menu" id="menu">
                    <li class="menu_item "><a style="color: black;" class="nav-link active" href="index.php">HOME</a>
                    </li>
                    <li class="menu_item "><a style="color: black;" class="nav-link" href="about.php">ABOUT</a></li>
                    <li class="menu_item "><a style="color: black;" class="nav-link" href="services.php">SERVICES</a>
                    </li>
                    <li class="menu_item "><a style="color: black;" class="nav-link" href="case_study.php">CASE
                            STUDIES</a></li>
                    <li class="menu_item "><a style="color: black;" class="nav-link" href="careers.php">CAREERS</a>
                    </li>
                    <li class="menu_item "><a style="color: black;" class="nav-link" href="blog.php">BLOG</a></li>
                </ul>
                            ...
                            <form action="./php_script/email.php" method="post" >
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" name="fullName" id="exampleInputName1"
                                        aria-describedby="emailHelp" required="require">
                                    </div>
                                    <div class="col">
                                    <label for="exampleInputCompany1" class="form-label">Company<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="company" id="exampleInputCompany1" required="require">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                    <label for="exampleInputEmail1" class="form-label">Email<span class="text-danger">*</span></label>
                                    <input type="email" class="form-control" name="email" id="exampleInputEmail1" required="require">
                                    </div>
                                    <div class="col">
                                    <label for="exampleInputPhone1" class="form-label">Phone<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="phone" id="exampleInputPhone1" required="require">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                    <label for="exampleInputInterest1" class="form-label">I'm Interest in<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="interest" id="exampleInputInterest1" required="require">
                                    </div>
                                    <div class="col">
                                    <label for="exampleInputBudget1" class="form-label">Budget<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="budget" id="exampleInputBudget1" required="require">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                    <label for="exampleInputMessage1" class="form-label">Message<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="message" id="exampleInputMessage1" required="require">
                                    </div>
                                </div>
