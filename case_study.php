   ...
   <?php include 'header.php'  ?>
            ...
            <div class="twocol__row">
                <div class="col-36">
                    ...
                    <h1 class="generic--head__head ">
                        We    <span class="primary-col text-primary ">Inspire & Innovate Brands</span>  For The Digital Future 
                    </h1>
                </div>
                <div class="col-30">
            ...
            <a class="filtered-div caseStudy_card text-decoration-none  d-flex flex-column " href="#" id="web" data-web = "web">
                ...
                <div class="case_study_desc_wrapper d-flex justify-content-between align-items-center ">
                    ...
                    <div class="d-flex justify-content-center align-items-center view_case-study">
                        <span class="me-4 ">View Case Study</span>
                        <div class="case_study_arrow">
                            <i style="color: rgb(255, 255, 255);" class="fa-solid fa-arrow-right"></i>
                        </div>
                    </div>
                </div>
            </a>
    ...
    <div class="right_heading">
        <div class="line-heading">
            <h3 class="case_study_outline_text" data-aos="slide-right" data-aos-once="ture">Concept. Strategy. Execute</h3>
        </div>
    </div>
        ...
        <a class="three-row-card text-decoration-none " href="#">
            ...
            <div class="three-card_desc d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-center align-items-center three_card_viewCase_study ">
                    ...
                    <div class="three_card_arrow">
                        <i style="color: rgb(255, 255, 255);" class="fa-solid fa-arrow-right"></i>
                    </div>
                </div>
            </div>
        </a>
        <a class="three-row-card second_card_col text-decoration-none " href="#">
