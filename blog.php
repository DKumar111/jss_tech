...
<body>
            ...
            <div class="blog_wrapper_container">
                <div class="twocolrow">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Events</h5>
                            <p class="card-text">Are you ready to mark your calendars and plan ahead for the joyous...
                            </p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Mobile Apps</h5>
                            <p class="card-text">From its inception, hybrid app development has been quite in trend. It
                                has been a...</p>
    ...
    <!-- BLOG SLIDER SECTION -->
    <div class="blogSlider_section pb-5  d-flex justify-content-center align-items-center ">
        <div class="blogSlider_container d-flex justify-content-center align-items-center   ">
            <div class="card" style="width: 900px;">
                <img height="100px" src="https://www.digitalgravity.ae/blog/wp-content/uploads/2024/04/Decoding-UAE-Social-Media-Trends-Insights-and-Statistics-for-2024-624x285.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Social Media Marketing</h5>
                    <p class="card-text">In the dynamic landscape of the United Arab Emirates (UAE), where innovation and technology intertwine...</p>
                </div>
            </div>
        </div>
    </div>
